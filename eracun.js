...
streznik.get('/', function(zahteva, odgovor) {
  if(zahteva.session.uporabnik == 'da') {
    ...
    pesmiIzKosarice(zahteva, function(pesmi) {
      if (!pesmi) {
        ...
        odgovor.send("<p>V košarici nimate nobene pesmi, \
          ...
          vrniTrenutnoStranko(strankaID, function(stranka){
...
var vrniTrenutnoStranko = function(strankaId, callback) {
...
streznik.post('/prijava', function(zahteva, odgovor) {
  ...
  form.parse(zahteva, function (napaka1, polja, datoteke) {
    ...
    try {
      ...
      povInf = "Stranka je bila uspešno registrirana.";
      stmt.finalize();
    } catch (err) {
      napaka2 = true;
      povInf = "Prišlo je do napake pri registraciji nove stranke.";
    }
...
streznik.get('/prijava', function(zahteva, odgovor) {
  vrniStranke(function(napaka1, stranke) {
      vrniRacune(function(napaka2, racuni) {
        odgovor.render('prijava', {sporocilo: povInf, seznamStrank: stranke, seznamRacunov: racuni});
        povInf = "";
      });
    });
});
